<div class="row justify-content-center style-one">
    <div class="col-11 col-lg-6 @php echo $block['position'] == 'left' ? 'order-1' : 'order-1 order-lg-2' @endphp">
        <div class="bg-image" style="background-image: url({!! $block['image']['url'] !!})">
        </div>
    </div>
    <div class="col-11 col-lg-6 @php echo $block['position'] == 'left' ? 'order-2' : 'order-2 order-lg-1' @endphp">
