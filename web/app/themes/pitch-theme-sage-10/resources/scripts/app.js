...
const main = async (err) => {
  ...
  function setSelect2() {
    ...
    function dropdown() {
        ...
        dropdownMenus.forEach((dropdownMenu) => {
            dropdownMenu.addEventListener('mouseenter', () => {
                Array.from(dropdownMenu.parentElement.children).forEach(
                    (child) => {
    ...
    function getPostsOnFilterChange() {
        ...
        if (blogFilterForm) {
            blogFilterForm.addEventListener('change', () => {
                const category =
                    blogFilterForm.querySelector('select#category').value;
                const month =
                    blogFilterForm.querySelector('select#month').value;
    ...
    function getMobileSubmenu() {
        jQuery('.navbar-mobile li.menu-item-has-children').on(
            'click',
            function (event) {
        ...
        if (geoLocationBtn) {
            geoLocationBtn.addEventListener('click', function (e) {
                ...
                if ('geolocation' in navigator) {
                    ...
                    geoLocationBtn.classList.add('d-none');
                }
            });
        }
